...
void weryfikacja_czasu(int* czas,int liczba_elementow){
    if ((czas[2]<0)||(czas[1]<0)||(czas[0]<0)||(czas[2]>59)||(czas[1]>59)||(czas[0]>23)){
        ...
        weryfikacja_czasu(czas, liczba_elementow);
    }
}
...
int main(void){
    ...
    weryfikacja_czasu(czas_1,liczba_elementow);
    dodawanie_liczb_do_tablicy(czas_2,liczba_elementow);
    weryfikacja_czasu(czas_2,liczba_elementow);
